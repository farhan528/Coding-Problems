...
#   obervation that the prime factor of any number will have occurences of 2s > 5s. So, basically we will calculate only the occurences of 5s because those many 5s will
